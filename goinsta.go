...
const (
	...
	goInstaSigKeyVersion    = "4f8732eb9ba7d1c8e8897a75d6474d4eb3f5279137431b2aafb71fafe2abe178"
...
func (insta *Instagram) Login() error {
	...
	insta.LogUser = &Result.LoggedInUser
	insta.Logged = true
...
func (insta *Instagram) UserFollowing(userID int64, maxID string) (r response.UsersResponse, err error) {
	req := acquireRequest()
